...
export async function GET(request: NextRequest) {
  ...
  const logoUrl = new URL("/webutilia-logo.png", request.nextUrl.origin).toString();
    ...
    >
      <div
        style={{
          ...
          borderRadius: "38px",
          boxShadow: "0 32px 90px rgba(4,120,87,0.15)",
          display: "flex",
      ...
      >
        <div style={{ alignItems: "center", display: "flex", justifyContent: "space-between" }}>
          <div style={{ alignItems: "center", display: "flex", fontSize: 30, fontWeight: 800, gap: 15 }}>
            <div style={{ alignItems: "center", display: "flex", height: 56, justifyContent: "center", width: 56 }}>
              {/* eslint-disable-next-line @next/next/no-img-element -- ImageResponse requires a plain image element. */}
              <img src={logoUrl} alt="" width={56} height={56} style={{ objectFit: "contain" }} />
            </div>
            Webutilia
          </div>
          <div style={{ background: "#ecfdf5", border: "1px solid #a7f3d0", borderRadius: 999, color: "#065f46", display: "flex", fontSize: 18, fontWeight: 700, padding: "10px 18px" }}>{category}</div>
        </div>
        ...
        <div style={{ color: "#047857", display: "flex", fontSize: 20, fontWeight: 750, gap: 30 }}>
