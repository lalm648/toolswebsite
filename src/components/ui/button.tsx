  ...
  "inline-flex items-center justify-center rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--ring-soft)] disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border border-[var(--outline-soft)] bg-white text-[var(--ink-900)] shadow-[var(--shadow-soft)] hover:-translate-y-0.5 hover:border-[var(--outline-strong)] hover:bg-[var(--accent-50)]",
        ghost: "text-slate-600 hover:bg-[var(--accent-50)] hover:text-[var(--accent-700)]",
      },
      size: {
